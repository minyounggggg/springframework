...
public class MessageController {
	...
	public String getMessage(Model model,
		...
		if(msgFlag.equals("userDeleteOk")) {
			...
			model.addAttribute("msg", "회원 로그인 후 사용가능합니다.");
			model.addAttribute("url", "/member/memberLogin");
		}
		...
		else if(msgFlag.equals("transactionUesrInputOk")) {
			model.addAttribute("msg", "user 테이블에 회원이 등록되었습니다.");
			if(tempFlag.equals("validator")) model.addAttribute("url", "/study/validator/validatorForm");
			else if (tempFlag.equals("transaction")) model.addAttribute("url", "/study/transaction/transactionForm");
		}
		else if(msgFlag.equals("transactionUesrInputNo")) {
			model.addAttribute("msg", "user 테이블에 회원 등록실패~!");
