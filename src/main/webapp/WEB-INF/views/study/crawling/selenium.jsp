			...
			$.ajax({
				...
				success : function (vos) {
					if(vos != ""){
						...
						str += '<tr class="table-secondary"><th>번호</th><th>영화제목</th><th>포스터</th><th>예매일</th></tr>';
...
<div class="container">
	...
	<form name="myform">
		<div class="input-group mb-3">
			...
			<div class="input-group-append"><input type="button" value="크롤링1" onclick="crawling1()" class="btn btn-success mr-3"/></div>
			<div class="input-group-append"><span id="spinnerIcon" style="display:none"> 검색중입니다.&nbsp;&nbsp;<span class="spinner-border"></span></span></div>
		</div>
	</form>
	<hr/>
	<form name="trainform">
