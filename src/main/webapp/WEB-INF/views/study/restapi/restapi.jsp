...
<div class="container">
	...
	<div class="mb-3">
		<a href="${ctp}/study/restapi/restapiTest1/Hello Springframework" class="btn btn-success">호출1(_)</a>
		<a href="${ctp}/restapi/restapiTest2/Hello Springframework" class="btn btn-success">호출2(_)</a>
		<a href="${ctp}/restapi/restapiTest3/Hello Springframework" class="btn btn-success">호출3(_)</a>
	</div>
	<hr/>
	...
	<hr/>
	<div class="mb-3">
		<a href="${ctp}/study/restapi/restapiTest4" class="btn btn-info">강력범죄 발생현황</a>
	</div>
	<hr/>
	<div id="demo"></div>
	<hr/>
