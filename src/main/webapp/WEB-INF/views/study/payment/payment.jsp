...
<div class="container">
  ...
  <form name="myform" method="post">
    ...
    <table class="table table-bordered">
      ...
      <tr>
	      <th>이메일</th>
	      <td><input type="text" name="buyer_email" value="minmin0325@naver.com" class="form-control"/></td>
      </tr>
      <tr>
	      <th>주문자</th>
	      <td><input type="text" name="buyer_name" value="행복영" class="form-control"/></td>
      </tr>
      <tr>
	      <th>연락처</th>
