...
<div class="container">
	...
	<hr/>
	<div>
		<input type="button" value="Numeric" onclick="randomCheck()" class="btn btn-info mr-2"/>
		<input type="button" value="UUID(16진수)" onclick="uuidCheck()" class="btn btn-info mr-2"/>
		<input type="button" value="AlphaNumeric" onclick="randomAlphaNumericCheck()" class="btn btn-info mr-2"/>
		<input type="button" value="새로고침" onclick="location.reload()" class="btn btn-success mr-2"/>
	</div>
	<hr/>
	<div>
		<div>출력결과 : </div>
