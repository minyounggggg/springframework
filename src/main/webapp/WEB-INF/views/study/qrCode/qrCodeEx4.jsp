...
<div class="container">
	...
	<form name="myform" method="post">
	    <table class="table table-bordered text-center">
		    ...
		    <tr>
		        <th>이메일</th>
		        <td><input type="text" name="email" id="email" value="minmin0325@naver.com" required class="form-control"/></td>
		    </tr>
	      <tr>
	        <th>영화명선택</th>
	        <td>
	      ...
	      <tr>
	        ...
	        <td>
				...
				얼라 <input type="number" name="movieChild" id="movieChild" value="0" min="0" required class="form-control"/>
			</td>
	      </tr>
	      <tr>
	        <td colspan="2">
	...
	<div>생성된 QR코드 : <br/>
		<div id="qrCodeView" style="display:none">
			...
			<div class="input-group">
				<input type="text" name="qrCode" id="bigo" class="form-control"/>
				<div class="input-grout-append">
