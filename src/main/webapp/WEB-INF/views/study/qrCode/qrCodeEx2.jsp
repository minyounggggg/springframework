...
<div class="container">
	...
	<div>(소개하고싶은 사이트의 주소를 입력해 주세요 : 예) 고궁, 문화재, 상품상세설명, 블로그 등등 )</div>
	<form name="myform" method="post">
	    <table class="table table-bordered text-center">
	      <tr>
	        <th>이동할 주소</th>
	        <td><input type="text" name="moveUrl" id="moveUrl" value="https://www.naver.com/" autofocus required class="form-control"/></td>
	      </tr>
	      <tr>
	        <td colspan="2">
