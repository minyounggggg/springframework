...
<p><br/></p>
<div class="container">
	<h2>kakaoDB에 저장된 키워드검색 후 MyDB에 저장하기(${address})</h2>
	<hr/>
	<form name="myform">
		<div>키워드 검색 : 
			<input type="text" name="address" id="address" autofocus required/>
			<input type="submit" value="키워드검색"/>
			<input type="button" value="검색된 지점 MyDB에 저장" onclick="addressSave()" class="btn btn-success btn-sm"/>
			<div id="demo"></div>
		</div>
