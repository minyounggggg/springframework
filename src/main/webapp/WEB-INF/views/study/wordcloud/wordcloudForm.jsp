		...
		function wordCheck3() {
	    	...
	    	$.ajax({
	    		...
	    		success:function(data) {
	    			...
	    			window.open('${ctp}/study/wordcloud/wordcloudShow', 'wordcloud', 'width=1020px,height=1020px'); 	//새창띄우기 
	    		},
	    		error : function() {
	    			alert("전송오류~");
	    		}
...
<div class="container">
	...
	<div>
		...
		<div class="row">
			<div class="col">
				<input type="button" value="Textarea내용 분석" onclick="wordCheck()" class="btn btn-success mb-2"/>
				<input type="button" value="Sample.txt내용 분석" onclick="wordCheck2()" class="btn btn-success mb-2"/>
				<input type="button" value="뉴스 크롤링 분석" onclick="wordCheck3()" class="btn btn-success mb-2"/>
			</div>
			<div class="col text-right">
				<input type="button" value="다시실행" onclick="location.reload()" class="btn btn-secondary"/>
			</div>
		</div>
		<hr/>
		<div class="input-group">
			<div class="input-group-text">제외할 문자열('/'로 구분해서 입력하세요)</div>
